 ...
 * is/are then able to connect and sent messages to this server. The server is able to sent messages to
 * a single specific client, or all client altogether. A message is represented by SoutilsMessage
